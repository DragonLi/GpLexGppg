...
// DateTime: 7/22/2018 4:59:33 PM
// UserName: fish.ke
// Input file <gppg.y - 7/22/2018 3:49:56 PM>
...
internal enum Token {
    ...
    kwScanBuffType=163,kwCsTokenFile=164,maxParseToken=165,errTok=166};
...
{
  // Verbatim content from gppg.y - 7/22/2018 3:49:56 PM
/*
 *  Parser spec for GPPG
 *  gppg.y: Author: John Gough, August 2008
 *  Process with > GPPG /gplex /no-lines gppg.y
 */
  // End verbatim content from gppg.y - 7/22/2018 3:49:56 PM
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{139,46,141,50,142,79,143,88,144,91,145,94,147,97,148,99,150,126,149,127,164,128,152,129,154,130,155,131,151,136,159,138,153,142,158,147,156,149,160,151,157,153,161,155,162,157,163,159,127,162,138,-11},new int[]{-10,1,-12,3,-17,44,-18,161,-19,49});
    ...
    states[13] = new State(new int[]{131,24,137,25,135,26,123,29,146,33,59,-99,124,-99},new int[]{-6,14,-7,19,-4,36,-37,27,-9,37,-8,28});
    states[14] = new State(-97,new int[]{-36,15});
    states[15] = new State(new int[]{59,16,124,17});
    states[16] = new State(-95);
    states[17] = new State(new int[]{131,24,137,25,135,26,123,29,146,33,59,-99,124,-99},new int[]{-6,18,-7,19,-4,36,-37,27,-9,37,-8,28});
    states[18] = new State(-98);
    states[19] = new State(new int[]{123,29,146,33,59,-100,124,-100},new int[]{-9,20,-8,28});
    states[20] = new State(new int[]{131,24,137,25,135,26,123,-104,146,-104,59,-104,124,-104},new int[]{-5,21,-4,22,-37,27});
    states[21] = new State(-103);
    states[22] = new State(new int[]{131,24,137,25,135,26,123,-105,146,-105,59,-105,124,-105},new int[]{-37,23});
    states[23] = new State(-107);
    states[24] = new State(-108);
    states[25] = new State(-109);
    states[26] = new State(-110);
    states[27] = new State(-106);
    states[28] = new State(-111);
    states[29] = new State(new int[]{129,10,125,-8,127,-8},new int[]{-16,30});
    states[30] = new State(new int[]{125,31,127,32});
    states[31] = new State(-114);
    states[32] = new State(-115);
    states[33] = new State(new int[]{131,34});
    states[34] = new State(new int[]{123,29,131,-113,137,-113,135,-113,146,-113,59,-113,124,-113},new int[]{-8,35});
    states[35] = new State(-112);
    states[36] = new State(new int[]{131,24,137,25,135,26,123,-101,146,-101,59,-101,124,-101},new int[]{-37,23});
    states[37] = new State(new int[]{131,24,137,25,135,26,123,-104,146,-104,59,-104,124,-104},new int[]{-5,38,-4,22,-37,27});
    states[38] = new State(-102);
    states[39] = new State(new int[]{58,40});
    states[40] = new State(-96);
    states[41] = new State(-93);
    states[42] = new State(-94);
    states[43] = new State(-4);
    states[44] = new State(new int[]{139,46,141,50,142,79,143,88,144,91,145,94,147,97,148,99,150,126,149,127,164,128,152,129,154,130,155,131,151,136,159,138,153,142,158,147,156,149,160,151,157,153,161,155,162,157,163,159,138,-10},new int[]{-18,45,-19,49});
    ...
    states[50] = new State(new int[]{60,74,131,-50,137,-50},new int[]{-20,51,-21,73});
    states[51] = new State(new int[]{131,55,137,59},new int[]{-1,52,-2,72});
    states[52] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,139,-18,141,-18,142,-18,143,-18,144,-18,145,-18,147,-18,148,-18,150,-18,149,-18,164,-18,152,-18,154,-18,155,-18,151,-18,159,-18,153,-18,158,-18,156,-18,160,-18,157,-18,161,-18,162,-18,163,-18,138,-18,131,-79,137,-79},new int[]{-28,53,-29,60});
    states[53] = new State(new int[]{131,55,137,59},new int[]{-2,54});
    states[54] = new State(-54);
    states[55] = new State(new int[]{133,56,135,57,44,-58,59,-58,58,-58,60,-58,62,-58,40,-58,41,-58,91,-58,93,-58,123,-58,125,-58,131,-58,137,-58,139,-58,141,-58,142,-58,143,-58,144,-58,145,-58,147,-58,148,-58,150,-58,149,-58,164,-58,152,-58,154,-58,155,-58,151,-58,159,-58,153,-58,158,-58,156,-58,160,-58,157,-58,161,-58,162,-58,163,-58,138,-58});
    states[56] = new State(-56);
    states[57] = new State(new int[]{133,58,44,-59,59,-59,58,-59,60,-59,62,-59,40,-59,41,-59,91,-59,93,-59,123,-59,125,-59,131,-59,137,-59,139,-59,141,-59,142,-59,143,-59,144,-59,145,-59,147,-59,148,-59,150,-59,149,-59,164,-59,152,-59,154,-59,155,-59,151,-59,159,-59,153,-59,158,-59,156,-59,160,-59,157,-59,161,-59,162,-59,163,-59,138,-59});
    ...
    states[81] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,139,-19,141,-19,142,-19,143,-19,144,-19,145,-19,147,-19,148,-19,150,-19,149,-19,164,-19,152,-19,154,-19,155,-19,151,-19,159,-19,153,-19,158,-19,156,-19,160,-19,157,-19,161,-19,162,-19,163,-19,138,-19,131,-79,132,-79},new int[]{-28,82,-29,86});
    ...
    states[88] = new State(new int[]{60,74,131,-50,137,-50},new int[]{-20,89,-21,73});
    states[89] = new State(new int[]{131,55,137,59},new int[]{-1,90,-2,72});
    states[90] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,139,-20,141,-20,142,-20,143,-20,144,-20,145,-20,147,-20,148,-20,150,-20,149,-20,164,-20,152,-20,154,-20,155,-20,151,-20,159,-20,153,-20,158,-20,156,-20,160,-20,157,-20,161,-20,162,-20,163,-20,138,-20,131,-79,137,-79},new int[]{-28,53,-29,60});
    states[91] = new State(new int[]{60,74,131,-50,137,-50},new int[]{-20,92,-21,73});
    states[92] = new State(new int[]{131,55,137,59},new int[]{-1,93,-2,72});
    states[93] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,139,-21,141,-21,142,-21,143,-21,144,-21,145,-21,147,-21,148,-21,150,-21,149,-21,164,-21,152,-21,154,-21,155,-21,151,-21,159,-21,153,-21,158,-21,156,-21,160,-21,157,-21,161,-21,162,-21,163,-21,138,-21,131,-79,137,-79},new int[]{-28,53,-29,60});
    states[94] = new State(new int[]{60,74,131,-50,137,-50},new int[]{-20,95,-21,73});
    states[95] = new State(new int[]{131,55,137,59},new int[]{-1,96,-2,72});
    states[96] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,139,-22,141,-22,142,-22,143,-22,144,-22,145,-22,147,-22,148,-22,150,-22,149,-22,164,-22,152,-22,154,-22,155,-22,151,-22,159,-22,153,-22,158,-22,156,-22,160,-22,157,-22,161,-22,162,-22,163,-22,138,-22,131,-79,137,-79},new int[]{-28,53,-29,60});
    states[97] = new State(new int[]{131,84,132,85},new int[]{-22,98});
    states[98] = new State(-23);
    states[99] = new State(new int[]{131,125,123,-46},new int[]{-23,100});
    ...
    states[104] = new State(-71);
    states[105] = new State(-73);
    states[106] = new State(new int[]{131,107},new int[]{-27,109,-25,110});
    states[107] = new State(new int[]{59,108,91,-48,46,-48,60,-48,131,-48});
    states[108] = new State(-75);
    states[109] = new State(-77);
    states[110] = new State(new int[]{91,111,46,113,60,115,131,-68,62,-68,44,-68,139,-68,141,-68,142,-68,143,-68,144,-68,145,-68,147,-68,148,-68,150,-68,149,-68,164,-68,152,-68,154,-68,155,-68,151,-68,159,-68,153,-68,158,-68,156,-68,160,-68,157,-68,161,-68,162,-68,163,-68,138,-68});
    ...
    states[137] = new State(new int[]{46,113,139,-33,141,-33,142,-33,143,-33,144,-33,145,-33,147,-33,148,-33,150,-33,149,-33,164,-33,152,-33,154,-33,155,-33,151,-33,159,-33,153,-33,158,-33,156,-33,160,-33,157,-33,161,-33,162,-33,163,-33,138,-33});
    states[138] = new State(new int[]{131,120},new int[]{-25,139});
    states[139] = new State(new int[]{46,113,59,141,139,-81,141,-81,142,-81,143,-81,144,-81,145,-81,147,-81,148,-81,150,-81,149,-81,164,-81,152,-81,154,-81,155,-81,151,-81,159,-81,153,-81,158,-81,156,-81,160,-81,157,-81,161,-81,162,-81,163,-81,138,-81},new int[]{-26,140});
    ...
    states[159] = new State(new int[]{131,120},new int[]{-27,160,-25,110});
    states[160] = new State(-44);
    states[161] = new State(-14);
    states[162] = new State(new int[]{139,46,141,50,142,79,143,88,144,91,145,94,147,97,148,99,150,126,149,127,164,128,152,129,154,130,155,131,151,136,159,138,153,142,158,147,156,149,160,151,157,153,161,155,162,157,163,159,138,-12,128,-3},new int[]{-18,163,-19,49});
    ...
    rules[44] = new Rule(-19, new int[]{163,-27});
    rules[45] = new Rule(-23, new int[]{131});
    rules[46] = new Rule(-23, new int[]{});
    rules[47] = new Rule(-25, new int[]{-25,46,131});
    rules[48] = new Rule(-25, new int[]{131});
    rules[49] = new Rule(-20, new int[]{-21});
    rules[50] = new Rule(-20, new int[]{});
    rules[51] = new Rule(-21, new int[]{60,131,62});
    rules[52] = new Rule(-21, new int[]{60,127,62});
    rules[53] = new Rule(-1, new int[]{-2});
    rules[54] = new Rule(-1, new int[]{-1,-28,-2});
    rules[55] = new Rule(-1, new int[]{-1,-29});
    rules[56] = new Rule(-2, new int[]{131,133});
    rules[57] = new Rule(-2, new int[]{131,135,133});
    rules[58] = new Rule(-2, new int[]{131});
    rules[59] = new Rule(-2, new int[]{131,135});
    rules[60] = new Rule(-2, new int[]{137});
    rules[61] = new Rule(-3, new int[]{-22});
    rules[62] = new Rule(-3, new int[]{-3,-28,-22});
    rules[63] = new Rule(-3, new int[]{-3,-29});
    rules[64] = new Rule(-22, new int[]{131});
    rules[65] = new Rule(-22, new int[]{132});
    rules[66] = new Rule(-27, new int[]{-25,91,93});
    rules[67] = new Rule(-27, new int[]{-25,60,-30,62});
    rules[68] = new Rule(-27, new int[]{-25});
    rules[69] = new Rule(-30, new int[]{-27});
    rules[70] = new Rule(-30, new int[]{-30,44,-27});
    rules[71] = new Rule(-24, new int[]{123,-31,125});
    rules[72] = new Rule(-31, new int[]{-32});
    rules[73] = new Rule(-31, new int[]{-31,-32});
    rules[74] = new Rule(-31, new int[]{127});
    rules[75] = new Rule(-32, new int[]{-33,131,59});
    rules[76] = new Rule(-33, new int[]{-27});
    rules[77] = new Rule(-33, new int[]{-33,-27});
    rules[78] = new Rule(-28, new int[]{44});
    rules[79] = new Rule(-28, new int[]{});
    rules[80] = new Rule(-26, new int[]{59});
    rules[81] = new Rule(-26, new int[]{});
    rules[82] = new Rule(-29, new int[]{59});
    rules[83] = new Rule(-29, new int[]{58});
    rules[84] = new Rule(-29, new int[]{60});
    rules[85] = new Rule(-29, new int[]{62});
    rules[86] = new Rule(-29, new int[]{40});
    rules[87] = new Rule(-29, new int[]{41});
    rules[88] = new Rule(-29, new int[]{91});
    rules[89] = new Rule(-29, new int[]{93});
    rules[90] = new Rule(-29, new int[]{123});
    rules[91] = new Rule(-29, new int[]{125});
    rules[92] = new Rule(-14, new int[]{-14,-34});
    rules[93] = new Rule(-14, new int[]{-34});
    rules[94] = new Rule(-14, new int[]{127});
    rules[95] = new Rule(-34, new int[]{-35,-6,-36,59});
    rules[96] = new Rule(-35, new int[]{132,58});
    rules[97] = new Rule(-36, new int[]{});
    rules[98] = new Rule(-36, new int[]{-36,124,-6});
    rules[99] = new Rule(-6, new int[]{});
    rules[100] = new Rule(-6, new int[]{-7});
    rules[101] = new Rule(-7, new int[]{-4});
    rules[102] = new Rule(-7, new int[]{-9,-5});
    rules[103] = new Rule(-7, new int[]{-7,-9,-5});
    rules[104] = new Rule(-5, new int[]{});
    rules[105] = new Rule(-5, new int[]{-4});
    rules[106] = new Rule(-4, new int[]{-37});
    rules[107] = new Rule(-4, new int[]{-4,-37});
    rules[108] = new Rule(-37, new int[]{131});
    rules[109] = new Rule(-37, new int[]{137});
    rules[110] = new Rule(-37, new int[]{135});
    rules[111] = new Rule(-9, new int[]{-8});
    rules[112] = new Rule(-9, new int[]{146,131,-8});
    rules[113] = new Rule(-9, new int[]{146,131});
    rules[114] = new Rule(-8, new int[]{123,-16,125});
    rules[115] = new Rule(-8, new int[]{123,-16,127});
...
{ grammar.LocationTypeName = LocationStack[LocationStack.Depth-1].ToString(); }
        break;
      case 44: // Declaration -> "%ScanBuffType", TypeConstructor
{ grammar.ScanBuffTypeName = LocationStack[LocationStack.Depth-1].ToString(); }
        break;
      case 45: // TypeNameOpt -> ident
{ SetSemanticType(LocationStack[LocationStack.Depth-1]); }
        break;
      case 51: // Kind -> '<', ident, '>'
{ CurrentLocationSpan = LocationStack[LocationStack.Depth-2]; }
        break;
      case 53: // TokenList -> TokenDecl
{
        ...
        break;
      case 54: // TokenList -> TokenList, CommaOpt, TokenDecl
{ ValueStack[ValueStack.Depth-3].tokenList.Add(ValueStack[ValueStack.Depth-1].tokenInfo); CurrentSemanticValue.tokenList = ValueStack[ValueStack.Depth-3].tokenList;}
        break;
      case 55: // TokenList -> TokenList, BadSeparator
{ handler.ListError(LocationStack[LocationStack.Depth-1], 75); CurrentSemanticValue.tokenList = ValueStack[ValueStack.Depth-2].tokenList; }
        break;
      case 56: // TokenDecl -> ident, number
{ 
        ...
        break;
      case 57: // TokenDecl -> ident, litstring, number
{ 
...
{ 
        ...
        break;
      case 62: // NtSymbolList -> NtSymbolList, CommaOpt, NtSymbol
{ ValueStack[ValueStack.Depth-3].stringList.Add(LocationStack[LocationStack.Depth-1].ToString()); CurrentSemanticValue.stringList = ValueStack[ValueStack.Depth-3].stringList; }
        break;
      case 63: // NtSymbolList -> NtSymbolList, BadSeparator
      ...
      case 102: // RHStermList -> PrecOptAndAction, SymbolsOpt
{
        ...
        break;
      case 103: // RHStermList -> RHStermList, PrecOptAndAction, SymbolsOpt
{
        ...
        break;
      case 104: // SymbolsOpt -> /* empty */
{ CurrentSemanticValue.stringList = null; }
        break;
      case 106: // Symbols -> SymOrLit
{ CurrentSemanticValue.stringList = new List<string>(); CurrentSemanticValue.stringList.Add(LocationStack[LocationStack.Depth-1].ToString()); }
        break;
      case 107: // Symbols -> Symbols, SymOrLit
{ ValueStack[ValueStack.Depth-2].stringList.Add(LocationStack[LocationStack.Depth-1].ToString());  CurrentSemanticValue.stringList = ValueStack[ValueStack.Depth-2].stringList; }
        break;
      case 111: // PrecOptAndAction -> Action
{ CurrentSemanticValue.proxy = ValueStack[ValueStack.Depth-1].proxy; }
        break;
      case 112: // PrecOptAndAction -> "%prec", ident, Action
