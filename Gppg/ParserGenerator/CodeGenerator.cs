...
namespace QUT.GPGen
{
    internal class CodeGenerator
    {
        ...
        private void GenerateClassHeader( string name )
        {
            ...
            GeneratedCodeAttribute();
            Console.WriteLine( "{2}{3} class {0}: ShiftReduceParser<{1}, {4}, {5}>", 
                              name, grammar.ValueTypeName, grammar.Visibility, grammar.PartialMark, grammar.LocationTypeName,grammar.ScanBuffTypeName);
            Console.WriteLine('{');
